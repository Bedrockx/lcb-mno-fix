...
public class AutoDomainTask : ISoloTask
{
    ...
    private async Task StartJsonFight()
    {
        ...
        var jsonParam = new AutoFightParam
        {
            ...
            FightFinishDetectEnabled = false,   // 压制check触发的战斗结束检测
            ExpKazuhaPickup = false,            // 压制经验检测/万叶拾取
            KazuhaPickupEnabled = false,        // 压制战后拾取
            PickDropsAfterFightEnabled = false,  // 压制通用拾取
            Timeout = 600,                       // 秘境单次战斗超时10分钟
        };
