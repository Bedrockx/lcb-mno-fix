...
/// <summary>
/// 版本校验结果（version-compatibility-check R5.2–R5.6）。
/// 服务端 BgiCoordinatorServer.Models.VersionCheckResult 的客户端镜像，字段名一致供 STJ 反序列化。
/// 通过 VersionCheckRejected 事件从服务端回传给被阻断的加入者展示。
/// </summary>
