...
{
    // ===== A 联机角色 =====
    [ObservableProperty] private bool _multiplayerEnabled = true;
    ...
    [ObservableProperty] private string _coordinatorClaimedVersion = "";
        ...
        string groupDefault)
    {
        ...
        _coordinatorClaimedVersion = GetStr("coordinatorClaimedVersion", g.CoordinatorClaimedVersion);
    ...
    public void WriteMultiplayerSettings(Dictionary<string, object?> settings)
    {
        ...
        settings["coordinatorClaimedVersion"] = CoordinatorClaimedVersion;
