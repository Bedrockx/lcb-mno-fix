...
public partial class OtherConfig : ObservableObject
{
    ...
    //空闲动作配置
    [ObservableProperty]
    private IdleAction _idleActionConfig = new();
    //锄地规划
    [ObservableProperty]
    ...
    public partial class IdleAction : ObservableObject
    {
        //空闲动作总开关
        [ObservableProperty]
        private bool _enabled = false;
        ...
        //传送至七天神像
        [ObservableProperty]
        private bool _teleportToStatue = true;
        ...
        //关闭原神
        [ObservableProperty]
        private bool _closeGenshin = false;
        
        //关闭BGI
        [ObservableProperty]
        private bool _closeBgi = false;
        
        //启动一条龙
        [ObservableProperty]
        private bool _oneDragonEnabled = false;
        
        //启动一条龙配置名称
        [ObservableProperty]
        private string _oneDragonConfigName = "";
        
        //启动配置组
        [ObservableProperty]
        private bool _configGroupEnabled = false;
        
        //启动配置组名称
        [ObservableProperty]
        private string _configGroupName = "";
        
        partial void OnOneDragonEnabledChanged(bool value)
        {
            if (value)
            {
                ConfigGroupEnabled = false;
                CloseGenshin = false;
                CloseBgi = false;
                Shutdown = false;
            }
        ...
        partial void OnConfigGroupEnabledChanged(bool value)
        {
            if (value)
            {
                OneDragonEnabled = false;
                CloseGenshin = false;
                CloseBgi = false;
                Shutdown = false;
            }
        ...
        partial void OnCloseGenshinChanged(bool value)
        {
            if (value)
            {
                OneDragonEnabled = false;
        ...
        partial void OnCloseBgiChanged(bool value)
        {
            if (value)
            {
                OneDragonEnabled = false;
